...
<title>Publications | Aviral Kumar</title>
<meta name="generator" content="Jekyll v3.9.0" />
<meta property="og:title" content="Publications" />
<meta property="og:locale" content="en_US" />
<meta name="description" content="Homepage of Aviral Kumar - UC Berkeley" />
<meta property="og:description" content="Homepage of Aviral Kumar - UC Berkeley" />
<link rel="canonical" href="/pubs/" />
<meta property="og:url" content="/pubs/" />
<meta property="og:site_name" content="Aviral Kumar" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="Publications" />
<script type="application/ld+json">
{"headline":"Publications","@type":"WebPage","url":"/pubs/","description":"Homepage of Aviral Kumar - UC Berkeley","@context":"https://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<ul>
  <li><strong>Offline Reinforcement Learning: Tutorial, Review and Perspectives on Open Problems</strong><br />
Sergey Levine, <strong><em>Aviral Kumar</em></strong>, George Tucker, Justin Fu<br />
<a href="https://arxiv.org/abs/2005.01643">[arXiv]</a>  (May 2020)<br />
In this tutorial paper, we present an introduction to offline RL, present a survey of classical and current deep offline RL approaches and discuss open problems and our perspectives on them.</li>
</ul>
...
<ul>
  <li>
    <p><strong>Datasets for Data-Driven Reinforcement Learning</strong><br />
Justin Fu, <strong><em>Aviral Kumar</em></strong>, Ofir Nachum, George Tucker, Sergey Levine<br />
<a href="https://arxiv.org/abs/2004.07219">[arXiv]</a> <a href="https://github.com/rail-berkeley/offline_rl">[Benchmark]</a> (April 2020)<br />
<em>At RL for Real Life Virtual Conference, 2020.</em><br />
In this paper, we introduce datasets and benchmarks for offline RL. Most of the prior offline RL research was carried out on datasets generated from RL policies or replay buffers obtained by training online RL agents. In this paper we introduce a suite of more realistic offline RL datasets, of the sort that is likely to be encountered in reality to stress test offline RL methods.</p>
  </li>
  <li>
    <p><strong>Reward-Condtioned Policies</strong><br />
<strong><em>Aviral Kumar</em></strong>, Xue Bin Peng, Sergey Levine   <a href="https://arxiv.org/abs/1912.13465">[arXiv]</a> (December 2019)<br />
In this paper, we pose reinforcement learning as a supervised learning problem that requires predicting the distribution of actions conditioned on the return of the policy. This allows us to reuse suboptimal trajectories for training as these trajectories are optimal conditioned on the return obtained by the policy that generated those trajectories.</p>
  </li>
  <li>
    <p><strong>Advantage-Weighted Regression: Simple and Scalable Off-Policy Reinforcement Learning</strong><br />
Xue Bin Peng, <strong><em>Aviral Kumar</em></strong>, Grace Zhang, Sergey Levine
<a href="https://xbpeng.github.io/projects/AWR/index.html">[Project Page]</a> (October 2019)
In this paper, we propose a simple off-policy (and offline) reinforcement learning algorithm that use a simple supervised regression approach to optimize the policy in reinforcment learning.</p>
  </li>
  <li>
    <p><strong>The Reach-Avoid Problem for Constant-Rate Multi-mode systems</strong><br />
  Krishna S, <strong><em>Aviral Kumar</em></strong>, Fabio Somenzi, Behrouz Touri, Ashutosh Trivedi<br />
  <em>(Alphabetically Sorted By Last Name)</em><br />
  15th International Symposium on Automated Technologies for Verification and Analysis, 2017
  <a href="https://link.springer.com/chapter/10.1007/978-3-319-68167-2_30">[Springer Link]</a></p>
  </li>
  <li>
    <p><strong>Challenges and Tool Implementation of Hybrid Rapidly-Exploring Random Trees</strong><br />
  Stanley Bak, Sergiy Bogomolov, Thomas A Henzinger, <strong><em>Aviral Kumar</em></strong>\<br />
  <em>(Alphabetically Sorted By Last Name)</em><br />
  10th Numerical Software Verification, CAV 2017<br />
  <a href="https://link.springer.com/chapter/10.1007/978-3-319-63501-9_6">[Springer Link]</a></p>
  </li>
</ul>
  ...
  <div class="wrapper">
    ...
    <h2 class="footer-heading">Aviral Kumar</h2>

    <div class="footer-col-wrapper">
      <div class="footer-col footer-col-1">
        <ul class="contact-list">
          <li class="p-name">Aviral Kumar</li><li><a class="u-email" href="mailto:aviralkumar2907@gmail.com">aviralkumar2907@gmail.com</a></li></ul>
      </div>

      <div class="footer-col footer-col-2"><ul class="social-media-list"><li><a href="https://github.com/aviralkumar2907"><svg class="svg-icon"><use xlink:href="/assets/minima-social-icons.svg#github"></use></svg> <span class="username">aviralkumar2907</span></a></li></ul>
</div>

      <div class="footer-col footer-col-3">
        <p>Homepage of Aviral Kumar - UC Berkeley</p>
      </div>
    </div>
